...
class ORUParser {
                    ...
                    if (segment.startsWith('MSH|')) {
                        ...
                        if (obxParts.length > 5) {
                            try {
                                ...
                                const result = {
                                    code: code,
                                    name: (metric === null || metric === void 0 ? void 0 : metric.name) || defaultName || code,
                                    value,
                                    units: (metric === null || metric === void 0 ? void 0 : metric.units) || units,
                                    referenceRange,
                                    abnormalFlag
                                };
    ...
    findMatchingMetric(code, name, units) {
        try {
                ...
                try {
                    ...
                    if (metric.oru_sonic_codes) {
                        const sonicCodes = metric.oru_sonic_codes
                            .split(';')
                            .map(c => c === null || c === void 0 ? void 0 : c.trim())
                            .filter((c) => c != null)
                            .map(c => c.toLowerCase());
